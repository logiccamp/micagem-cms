...
<body>
    <div id="app">
        <div class="banner overlay" id="{{$page->page_name !== 'Home' ? 'page' : ''}}" style='background: url("/storage/{{$page->banner}}"); background-repeat: no-repeat; background-size: cover; background-position: center !important;'>
